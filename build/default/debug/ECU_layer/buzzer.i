...
# 1 "ECU_layer/buzzer.h" 1
# 10 "ECU_layer/buzzer.h"
...
# 12 "ECU_layer/../MCAL_layer/GPIO/hal_gpio_cfg.h"
...
# 12 "ECU_layer/../MCAL_layer/GPIO/hal_gpio_cfg.h" 2
...
# 13 "ECU_layer/../MCAL_layer/GPIO/hal_gpio_cfg.h" 2
...
# 15 "ECU_layer/../MCAL_layer/GPIO/hal_gpio_cfg.h" 2
# 25 "ECU_layer/../MCAL_layer/GPIO/hal_gpio_cfg.h"
...
# 10 "ECU_layer/buzzer.h" 2


typedef struct{
    uint8 port :3;
    uint8 pin :3;
    uint8 buzzer_status :1;
}buzzer_t;

Std_ReturnType Buzzer_Init(buzzer_t *buzzer);
Std_ReturnType Buzzer_on(buzzer_t *buzzer);
Std_ReturnType Buzzer_off(buzzer_t *buzzer);
Std_ReturnType Buzzer_toggle(buzzer_t *buzzer);
# 7 "ECU_layer/buzzer.c" 2
...
Std_ReturnType Buzzer_Init(buzzer_t *buzzer){
    ...
    if(buzzer == ((void*)0)){
        ...
        pin_config_t pin_config_obj = {
            .port = buzzer->port, .pin = buzzer->pin, .direction = GPIO_direction_output, .logic = buzzer->buzzer_status
        };
