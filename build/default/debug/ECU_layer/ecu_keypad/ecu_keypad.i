...
# 12 "ECU_layer/ecu_keypad/../../MCAL_layer/GPIO/hal_gpio.h"
# 1 "ECU_layer/ecu_keypad/../../MCAL_layer/GPIO/hal_gpio_cfg.h" 1
# 12 "ECU_layer/ecu_keypad/../../MCAL_layer/GPIO/hal_gpio_cfg.h"
...
# 12 "ECU_layer/ecu_keypad/../../MCAL_layer/GPIO/hal_gpio_cfg.h" 2
...
# 13 "ECU_layer/ecu_keypad/../../MCAL_layer/GPIO/hal_gpio_cfg.h" 2
...
# 15 "ECU_layer/ecu_keypad/../../MCAL_layer/GPIO/hal_gpio_cfg.h" 2
# 25 "ECU_layer/ecu_keypad/../../MCAL_layer/GPIO/hal_gpio_cfg.h"
...
# 21 "ECU_layer/ecu_keypad/ecu_keypad.h"
typedef struct{
...
Std_ReturnType keypad_intialize(const keypad_t *_keypad_obj){
    ...
    uint8 l_row = 0, l_column = 0;
    if(((void*)0) == _keypad_obj){
        ret = (Std_ReturnType)0x00;
    }
    else{
        for(l_row = 0;l_row < 4;l_row++){
            ret = gpio_pin_intialize(&(_keypad_obj->keypad_row_pin[l_row]));
        }
        for(l_column = 0;l_column < 4;l_column++){
            ret = gpio_pin_direction_intialize(&(_keypad_obj->keypad_row_pin[l_column]));
        }
    }
    return ret;
}
...
Std_ReturnType keypad_get_value(const keypad_t *_keypad_obj, uint8 *value){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    uint8 l_row = 0, l_column = 0,l_counter = 0;
    ...
    if((((void*)0) == _keypad_obj) || ((void*)0) == value){
        ...
        for(l_row = 0;l_row < 4;l_row++){
           for(l_counter = 0;l_counter < 4;l_counter++){
               ret = gpio_pin_write_logic(&_keypad_obj->keypad_row_pin[l_counter],GPIO_LOW);
        }
           gpio_pin_write_logic(&(_keypad_obj->keypad_row_pin[l_row]),GPIO_HIGH);
           _delay((unsigned long)((10)*(4000000/4000.0)));
            for(l_column = 0;l_column < 4;l_column++){
                ret = gpio_pin_read_logic(&(_keypad_obj->keypad_row_pin[l_column]),&column_logic);
                if(GPIO_HIGH == column_logic){
                    *value = btn_values[l_row][l_column];
                }
            }
        }
    }
